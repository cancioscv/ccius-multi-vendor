...
const SalesChart = dynamic(() => import("../../shared/components/charts/sales-chart").then((mod) => mod.default), {
  ssr: false,
  loading: () => <p className="text-white">Loading SalesChart...</p>,
});

const GeographicalMapChart = dynamic(() => import("../../shared/components/charts/geographical-map-chart"), {
  ssr: false,
