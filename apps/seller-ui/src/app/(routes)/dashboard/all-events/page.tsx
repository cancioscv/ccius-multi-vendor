...
import { BarChart, Eye, Plus, Search, Star, Trash2 } from "lucide-react";
  ...
  const columns = useMemo(
    () => [
      ...
      },
      {
        ...
        cell: ({ row }) => (
          <div>
            <span>{row.original.endingDate.slice(0, 10)}</span>
          </div>
        ),
      },
      {
  ...
  return (
    <div className="w-full min-h-screen p-8">
      ...
      <div className="flex justify-between items-center mb-1">
        ...
        <Link href="/dashboard/create-event" className="bg-blue-600 hover:bg-blue-700 text-white px-4 py-2 rounded-lg flex items-center gap-2">
