...
export default function Page() {
  ...
  const { data: conversations, isLoading } = useQuery({
    ...
    queryFn: async () => {
      const res = await axiosInstance.get("/chat/api/user-conversations", isProtected);
      ...
      <div className="md:w-[80%] mx-auto pt-5">
        <div className="flex h-[80vh] shadow-sm overflow-hidden">
          <div className="w-[320px] border-r border-r-gray-200 bg-gray-50">
            <div className="p-4 border-b border-b-gray-200 text-lg font-semibold text-gray-800">Messages</div>
                      ...
                      <div className="flex items-center gap-3">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-xs text-gray-500 truncate max-w-[170px]">
                            ...
                            {chat.unreadCount > 0 && (
                              <span className="bg-red-500 ml-2 text-white text-[10px] font-bold px-1 py-0.5 rounded-full">{chat.unreadCount}</span>
                            )}
                          </p>
                        </div>
                      </div>
                ...
                <div ref={messageContainerRef} className="flex-1 overflow-y-auto px-6 py-6 space-y-4 text-sm">
                  {hasMore && (
                    <div className="flex justify-center mb-2">
                      <button onClick={loadMoreMessages} className="text-xs px-4 py-1 bg-gray-200 hover:bg-gray-300 rounded-full text-gray-700">
