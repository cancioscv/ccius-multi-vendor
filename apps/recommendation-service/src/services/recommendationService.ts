...
import { getUserActivity } from "./fetchUserActivity.js";
...
export async function recommendProducts(userId: string, allProducts: any): Promise<string[]> {
  ...
  // Flatten the 2D embeddings into 1D feature eveectors
  ...
  // Converrt user and product interactions into tensors for training
